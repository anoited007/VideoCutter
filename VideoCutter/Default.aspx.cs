...
namespace VideoCutter
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        private CloudBlobContainer getVideoCutterContainter()
        {
            return _blobStorageService.getCloudBlobContainer();
        }

        private CloudQueue getVideoCutterMakerQueue()
        {
        ...
        protected void submitButton_Click(object sender, EventArgs e)
        {
            if (upload.HasFile)
            {
                ...
                var blob = getVideoCutterContainter().GetBlockBlobReference(path);
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            try
            {
                ...
                // showing 
                VideoCutterDisplayControl.DataBind();
            }
            catch (Exception)
            {
            }
